...
//                rbFeedback.setOnRatingBarChangeListener(onRatingBarChangeListener);
    ...
    public void loademojis(int position) {
        ...
        switch (position) {
            case 0:
                Glide.with(mContext).load(R.drawable.feedback_icon_1).apply(new RequestOptions().diskCacheStrategy(DiskCacheStrategy.NONE)).into(new DrawableImageViewTarget(icon_1));
                break;
            case 1:
