...
package kore.botssdk.io.crossbar.autobahn.websocket.types;
...
public class WebSocketOptions {
    ...
    public WebSocketOptions() {
        ...
        mMaxFramePayloadSize = 256 * 1024;
        mMaxMessagePayloadSize = 256 * 1024;
        ...
        mAutoPingTimeout = 5;
        origin = SDKConfiguration.Server.SERVER_URL;
    }
