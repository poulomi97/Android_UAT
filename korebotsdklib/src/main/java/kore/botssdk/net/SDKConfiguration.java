...
public class SDKConfiguration {
    ...
    public static class JWTServer {
        static final String JWT_SERVER_URL = "https://philips.kore.ai/api/users/sts";
    }
    ...
    public static class Server {
        ...
        static  String KORE_BOT_SERVER_URL = "https://eu-bots.kore.ai/";//https://qa-bots.kore.ai";
        public static final String TTS_WS_URL = "wss://speech.kore.ai/speechcntxt/ws/speech";
        public static final boolean IS_ANONYMOUS_USER = true;
        public static   String SERVER_URL = "https://eu-bots.kore.ai/"; // "https://demo.kore.net";
        ...
        public static final String koreAPIUrl = "https://eu-bots.kore.ai/";
    }

    public static class Client {
        //SDK 2.0
        public static final String client_id = "cs-e8f9fb26-964d-5a93-9076-bd8fda2ea21f";//"cs-96c4747a-bb79-58b0-9dca-0dcf6c6148cf";//"cs-dc0f84ac-4751-5293-b254-6a0a382ab08c";//"cs-a269ad0a-45ec-5b41-9950-18571e42a6a4";//"cs-5649368e-68bb-555a-8803-935f223db585";
        public static final String client_secret = "TBhqcPB/KH6IvCQHRZKuZNc09UfpJ46ceBFRkH/eYJo=";//"qc4c+FOpEo88m27BgECpcS/oC/CKDWa8u70ll0qr4MM=";//"MiFzNLLWTQZddj1HOmdM4iyePhQ+gED4jdUg88Ujh1Y=";//"kmZ7ck9wRxSVV2dNNwi2P3UZI3qacJgu7JL9AmZapS4=";//"AHSubkG09DRdcz9xlzxUXfrxyRx9V0Yhd+6SnXtjYe4=";

        public static String identity = "poulomi.sharma@mresult.com";
        public static final String bot_name = "Sia";//"Android test";//"NewTemplates";
        public static final String bot_id = "st-7160c6de-4984-5e2c-a18f-01fc4a075190";//"st-2e4c9eaf-070c-5b86-8020-add76f37e3a2";//"st-05303785-9992-526c-a83c-be3252fd478e";//"st-caecd28f-64ed-5224-a612-7a3d3a870aed";//"st-cc32974e-c7a2-52d1-83bf-c3dc2b2a9db3";
        ...
        public static final String webHook_client_id = "cs-e8f9fb26-964d-5a93-9076-bd8fda2ea21f";//"cs-96c4747a-bb79-58b0-9dca-0dcf6c6148cf";//"cs-dc0f84ac-4751-5293-b254-6a0a382ab08c";//"cs-a269ad0a-45ec-5b41-9950-18571e42a6a4";//"cs-5649368e-68bb-555a-8803-935f223db585";
        public static final String webHook_client_secret = "TBhqcPB/KH6IvCQHRZKuZNc09UfpJ46ceBFRkH/eYJo=";//"qc4c+FOpEo88m27BgECpcS/oC/CKDWa8u70ll0qr4MM=";//"MiFzNLLWTQZddj1HOmdM4iyePhQ+gED4jdUg88Ujh1Y=";//"kmZ7ck9wRxSVV2dNNwi2P3UZI3qacJgu7JL9AmZapS4=";//"AHSubkG09DRdcz9xlzxUXfrxyRx9V0Yhd+6SnXtjYe4=";
        public static final String webHook_identity = "poulomi.sharma@mresult.com";
        public static final String webHook_bot_id = "st-7160c6de-4984-5e2c-a18f-01fc4a075190";//"st-2e4c9eaf-070c-5b86-8020-add76f37e3a2";//"st-05303785-9992-526c-a83c-be3252fd478e";//"st-caecd28f-64ed-5224-a612-7a3d3a870aed";//"st-cc32974e-c7a2-52d1-83bf-c3dc2b2a9db3";

        //Weebhook
        // for webhook based communication use following option
        public static String webhookURL = "https://eu-bots.kore.ai/chatbot/v2/webhook/st-7160c6de-4984-5e2c-a18f-01fc4a075190";
